/*
  # Clean up and consolidate posts table migrations

  1. Changes
    - Consolidate all posts table related migrations into a single file
    - Remove redundant migrations
    - Ensure proper foreign key relationships
    - Maintain all necessary policies and triggers

  2. Security
    - Maintain RLS policies
    - Keep profile existence check
